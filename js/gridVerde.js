var GridVerde = (function() {
	...
	var config = {
			items : Array.prototype.slice.call( document.querySelectorAll( '#gt-gridVerde > div' ) ),
			gridSel : new gridSelectorVerde( document.getElementById( 'gt-gridVerde-selector' ), {
